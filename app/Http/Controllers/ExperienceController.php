...
class ExperienceController extends Controller
{
    ...
    public function edit(string $id)
    {
        ...
        return view('experience.edit', ['data' => $data]);
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('experience.index')->with('success', 'Berhasil melakukan perubahan data');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect()->route('experience.index')->with('success', 'Berhasil melakukan penghapusan data');
    }
}
