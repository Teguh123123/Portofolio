    ...
    public function update(Request $request)
    {
        if($request->method() == 'POST') {
            $request->validate([
                ...
                '_language.required' => 'Silahkan masukkan bahasa pemograman yang dikuasai',
                '_workflow.required' => 'Silahkan masukkan workflow yang dikuasai',
            ]);
            ...
            return redirect()->route('skill.index')->with('success', 'Berhasil melakukan perubahan data');
        }
    }
}
